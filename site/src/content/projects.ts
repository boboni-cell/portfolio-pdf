...
const koreahospitalZh: ProjectDetail = {
  ...
  name: '运营工作台', nameEn: 'AI-Driven Social Media Operations Workbench',
  ...
  sections: [
    { id: 'overview', label: 'Overview', title: 'AI 与人共驾的运营驾驶舱', body: 'Koreahospital 运营工作台为一家韩国植发医院服务 10 个小红书 / 抖音账号。系统把账号定位、选题、内容生产、合规审核、发布、数据回填和复盘收进同一个界面：AI 负责研究和初稿，人负责最终判断。每一条内容的来源、版本、状态与发布后表现都可追溯，每周复盘建立在真实数据之上而不是主观感受。', items: [{ label: 'AI 主导执行', body: '研究员、策略师、写手、风险审核、复盘员等角色各自独立工作，运营人员通过输入框与队长对话驱动整个流程。' }, { label: '人主导判断', body: 'AI 初审跑完风险、证据、格式扫描之后，仍由人做最终审核。医疗广告法重灾区，自动化不能取代人。' }, { label: '数据全程留痕', body: '每个选题、每篇内容、每次发布、每个数据快照都保存到项目数据库，事后复盘可逐条回看。' }] },
    { id: 'background', label: 'Why This Project', title: '为什么做这个工作台？', body: '医美机构做社媒，三件事同时在崩坏：专业度、合规线和人力。一个 AI 工具解决不了三件事，但一套工作流可以。', cards: [{ num: '01', title: '矩阵规模失控', body: '一家医院要跑 10 个账号，每个账号定位不同、平台不同、人设不同。3 个运营人员手搓，意味着每条内容都从零开始。' }, { num: '02', title: '合规线随时踩雷', body: '医美是广告法重灾区：效果对比、承诺性表述、未授权的医生信息，每一条都可能下架。人工审核不可靠，全自动审核会误杀。' }, { num: '03', title: '数据无回流', body: '发了 100 条内容，没人知道哪条为什么爆。每周复盘是运营人员的噩梦，结论停留在"感觉"而不是"数据"。' }, { num: '04', title: 'AI 工具救不了结构问题', body: '单点 AI 工具（写文案 / 生图 / 剪视频）反而制造新负担——每个工具一个登录、一种格式、一次人工搬运。需要的是工作台，不是一堆工具的合集。' }] },
    { id: 'workflow', label: 'Operations Workflow', title: '一条内容从想法到复盘', body: '7 步闭环：先定方向 → 找值得做的题 → 做一篇内容 → 两道审核 → 人工发布 → 回填真实数据 → 复盘并改进。发布不是终点，数据回填 + 复盘归因才是下一轮的开始。', cards: [{ num: '01', title: '先定方向', body: '项目·人群·账号定位 / 平台分工·医疗合规边界。产出：项目简报' }, { num: '02', title: '找值得做的题', body: '平台信号·竞品·用户问题 / AI 提建议，人工确认再入池。产出：已确认选题' }, { num: '03', title: '做一篇内容', body: '先写母版简报 / 再做平台版本 / 小红书图文·抖音脚本分镜。产出：内容与素材' }, { num: '04', title: '两道审核', body: 'AI 初审：风险·证据·格式 / 人工终审：准确性·表达·授权。产出：审核通过' }, { num: '05', title: '人工发布', body: '系统生成发布包 / 运营人员复制到平台并手动发布。产出：发布快照' }, { num: '06', title: '回填真实数据', body: '24h·7d·30d 三个窗口 / 手动填写或粘贴 CSV / 表格。产出：数据快照' }, { num: '07', title: '复盘并改进', body: 'AI 归因，人工确认 / 更新选题·结构·CTA·节奏。产出：下一轮经验' }], highlight: '不是把 10 个工具拼起来，而是把 10 个工作流压成一个工作台。', highlightLabel: '核心设计', image: '/media/koreahospital/02-content-production.png', imageAlt: '内容生产与每日热点', image2: '/media/koreahospital/03-topic-pool.png', image2Alt: '选题池与 AI 选题建议', image3: '/media/koreahospital/04-content-management.png', image3Alt: '按平台管理待发布内容', mediaMode: 'tabs', tabLabelsZh: ['每日热点', '选题池', '内容管理'], imageCaption: '每日热点把平台趋势、热度和来源集中在同一视图，帮助团队从信号开始规划内容。', image2Caption: '选题池保留热度、状态和素材入口，AI 建议与人工确认在同一条流程里完成。', image3Caption: '内容管理按平台与发布状态组织草稿、待发布和已发布内容，减少跨工具搬运。' },
    { id: 'architecture', label: 'System Architecture', title: '从入口到终端的 5 大泳道', body: '不是工作流图，是一个真实在跑的 Agent 系统：5 个泳道（Workflow / Project Context / Agent / Web / Modal）各司其职，每个泳道都对应一个具体功能模块。', image: '/media/koreahospital/08-settings.png', imageAlt: '系统设置中的运营人员与模型技能', imageCaption: '系统设置把运营人员、模型 / Skill、素材权限和平台规则集中管理，让协作边界清晰可审计。', mediaMode: 'feature' },
    { id: 'dashboard', label: 'Operations Dashboard', title: '一张图看清今天要做什么', body: '运营工作台首页：Agent 队长的输入框在最上面，下面是 4 张数据卡 + 5 步流程 + Kanban 内容板。3 个运营人员打开同一个页面，状态永远一致。', cards: [{ num: 'Agent', title: '6 个角色 · 真 key 全绿', body: '队长的输入框接受自然语言指令，6 个角色 Agent 按能力拆分任务。' }, { num: 'KPI', title: '4 张数据卡', body: '待处理 3 / 待审核 0 / 账号矩阵 10 / 可用素材 9——一页看见所有关键状态。' }, { num: 'Pipeline', title: '5 步流程', body: '信号 → 策略 → 生产 → 排期 → 复盘，颜色与数据卡一致，扫一眼知道现在卡在哪一步。' }, { num: 'Kanban', title: 'Kanban 内容板', body: '待制作 / 待发布 / 待复盘 三栏拖动，每张内容卡显示来源选题、当前阶段、负责人和下一步。' }], image: '/media/koreahospital/01-operations-dashboard.png', imageAlt: '运营工作台首页总览', image2: '/media/koreahospital/09-toni-assistant.png', image2Alt: 'Toni Agent 助手对话面板', mediaMode: 'tabs', tabLabelsZh: ['工作台总览', 'Toni 助手'], imageCaption: '首页用输入框、状态卡、流程和 Kanban 把今天的运营任务压缩成一张可执行的地图。', image2Caption: 'Toni 助手作为统一入口，把“看管线、标发布、刷新”等自然语言请求转成下一步动作。' },
    { id: 'execution-plan', label: 'Multi-Agent Collaboration', title: '一句话拆成 9 步的协作剧本', body: '运营在输入框说一句"搜一下最近小红书韩国医美的热点"，队长把它拆给研究员、策略师、风险审核，每个角色独立工作，结果可回滚、可复用。', cards: [{ num: 'Researcher', title: '研究员', body: '调用 space-xhs-hotspot 技能，按关键词拉取近 30 天高互动笔记，输出热点表格、趋势判断、来源 URL 全部留痕。' }, { num: 'Strategist', title: '策略师', body: '基于研究员结果筛出最具潜力的趋势方向，标注讨论热度、增长曲线、可执行性，给出优先级建议。' }, { num: 'Compliance', title: '风险审核', body: '对策略师的输出跑合规扫描——医美广告法、平台规则、医生背书授权，命中红线直接打回并给出修改建议。' }], image: '/media/koreahospital/06-execution-plan.png', imageAlt: '多 Agent 执行计划与研究结果', image2: '/media/koreahospital/05-asset-detail.png', image2Alt: '素材中心的授权与分类详情', mediaMode: 'tabs', tabLabelsZh: ['执行计划', '素材详情'], imageCaption: '执行计划展开研究员、策略师与总结角色的产出，保留来源、数据和可回滚的协作证据。', image2Caption: '素材详情记录授权、分类、使用次数与下载权限，让医美素材在发布前可验证。' },
    { id: 'post-analysis', label: 'Data Center', title: '数据不撒谎：诚实展示"未提供"', body: '互动率、分享率、涨粉转化率都以有效浏览为分母。样本不足 1000 不进入归因结论；官方文件没有单帖涨粉就显示"未提供"，不靠账号日增粉反推。', cards: [{ num: '低样本', title: '低样本仍展示但不归因', body: '有效浏览不足 1000 仍展示，但不进入中位数与归因结论。' }, { num: '平台分开', title: '平台分开统计', body: '小红书阅读与抖音播放均称有效浏览，两个平台不合并比率。' }, { num: '不制造归因', title: '不制造归因', body: '官方文件没有单帖涨粉时显示"未提供"，不用账号日增粉推算。' }], image: '/media/koreahospital/07-post-analysis.png', imageAlt: '帖子分析与数据中心', imageCaption: '数据中心把平台、账号与时间窗口分开，低样本明确标记“未提供”，不制造虚假的归因结论。', mediaMode: 'feature' },
    { id: 'summary', label: 'Project Summary', title: '6 角色 · 7 步 · 10 账号 · 1 个工作台', body: 'Koreahospital 运营工作台不是把 10 个工具拼起来，而是把 10 个工作流压成一个工作台。每个动作可追溯，每个数字有来源，每个判断有依据。', highlight: '人做最终判断，AI 做辅助工作。', highlightLabel: '核心哲学' },
  ],
};

const koreahospitalKo: ProjectDetail = {
  slug: 'koreahospital', num: '03',
  name: '운영 워크벤치', nameEn: 'AI-Driven Social Media Operations Workbench',
  ...
  nextProject: { slug: 'milk-ribbon', name: 'Milk & Ribbon 브랜드 디자인' },
  sections: [
    { id: 'overview', label: 'Overview', title: 'AI와 사람이 함께하는 운영 조종석', body: 'Koreahospital 운영 워크벤치는 한 한국 모발이식 병원이 10개 샤오홍슈 / 틱톡 계정을 운영하도록 돕는다. 계정 포지셔닝, 소재, 콘텐츠 제작, 컴플라이언스审核, 발행, 데이터 회귀, 회고를 한 화면에 통합: AI는 연구와 초안을 담당하고, 사람은 최종 판단을 한다. 모든 콘텐츠의 출처·버전·상태·발행 후 성과가 추적 가능해져, 주간 회고는 감이 아닌 실제 데이터에 기반한다.', items: [{ label: 'AI가 실행 주도', body: '연구원·전략가·작가·리스크审核·회고 담당 등 역할이 각자 독립적으로 작업하며, 운영자는 입력창으로 팀장과 대화하며 전체 흐름을 이끈다.' }, { label: '사람이 판단 주도', body: 'AI 1차 심사가 리스크·증거·포맷을 스캔한 뒤에도 최종 판단은 사람 몫이다. 의료 미용 광고법 중灾区에서 자동화는 사람을 대체할 수 없다.' }, { label: '데이터 전 과정 기록', body: '모든 소재·콘텐츠·발행·데이터 스냅샷이 프로젝트 데이터베이스에 저장되어 사후 회고 시 한 줄씩 다시 볼 수 있다.' }] },
    { id: 'background', label: 'Why This Project', title: '왜 이 워크벤치를 만들었는가?', body: '의료 미용 기관의 SNS 운영에서 세 가지가 동시에 무너진다 — 전문성, 컴플라이언스 라인, 인력. AI 도구 하나가 세 가지를 해결하지 못하지만, 하나의 워크플로우는 해결할 수 있다.', cards: [{ num: '01', title: '매트릭스 규모 통제 불능', body: '한 병원이 10개 계정을 운영해야 하고, 계정마다 포지셔닝·플랫폼·페르소나가 다르다. 운영자 3명이 손으로 하면 매번 콘텐츠를 제로부터 시작한다.' }, { num: '02', title: '컴플라이언스 라인이 항상 위험', body: '의료 미용은 광고법 중灾区: 효과 비교, 약속성 표현, 무授权 의료진 정보 — 한 줄이 계정을 정지시킨다. 수동审核은 불안하고, 완전 자동审核은 오살.' }, { num: '03', title: '데이터 회귀 없음', body: '100건의 콘텐츠를 발행했지만 어떤 게 왜 터졌는지 아무도 모른다. 주간 회고는 운영자의 악몽이고, 결론은 "느낌"이 아닌 "데이터"에 머물러야 한다.' }, { num: '04', title: 'AI 도구는 구조 문제를 해결 못함', body: '단일 AI 도구(카피라이팅 / 이미지 생성 / 영상 편집)는 오히려 새로운 부담을 만든다 — 도구마다 다른 로그인, 다른 포맷, 수동 옮기기. 도구의 모음이 아닌 워크벤치가 필요하다.' }] },
    { id: 'workflow', label: 'Operations Workflow', title: '콘텐츠 한 건: 아이디어에서 회고까지', body: '7단계 폐쇄 루프: 방향 설정 → 가치 있는 소재 발굴 → 콘텐츠 제작 → 두 단계审核 → 수동 발행 → 실제 데이터 회귀 → 회고와 개선. 발행을 끝이 아니라, 데이터 회귀 + 회고 귀인이 다음 라운드의 시작이다.', cards: [{ num: '01', title: '방향 설정', body: '프로젝트·대상·계정 포지셔닝 / 플랫폼 분업·의료 컴플라이언스 경계. 산출: 프로젝트 브리퍼' }, { num: '02', title: '가치 있는 소재 발굴', body: '플랫폼 신호·경쟁사·사용자 문제 / AI 제안, 사람 확인 후 풀 입고. 산출: 확인된 소재' }, { num: '03', title: '콘텐츠 제작', body: '마스터 브리퍼 작성 / 플랫폼별 버전 / 샤오홍슈图文·틱톡 대본 스토리보드. 산출: 콘텐츠와 에셋' }, { num: '04', title: '두 단계审核', body: 'AI 1차: 리스크·증거·포맷 / 사람 최종: 정확성·표현·授权. 산출:审核 통과' }, { num: '05', title: '수동 발행', body: '시스템이 발행 패키지 생성 / 운영자가 복사해 플랫폼에 수동 발행. 산출: 발행 스냅샷' }, { num: '06', title: '실제 데이터 회귀', body: '24h·7d·30d 세 개 윈도우 / 수동 입력 또는 CSV·표 붙여넣기. 산출: 데이터 스냅샷' }, { num: '07', title: '회고와 개선', body: 'AI 귀인, 사람 확인 / 소재·구조·CTA·리듬 업데이트. 산출: 다음 라운드 경험' }], highlight: '10개 도구를 이어 붙인 게 아니라, 10개 워크플로우를 하나의 워크벤치로 압축했다.', highlightLabel: '핵심 설계', image: '/media/koreahospital/02-content-production.png', imageAlt: '매일 핫이슈 콘텐츠 생산', image2: '/media/koreahospital/03-topic-pool.png', image2Alt: '소재 풀과 AI 소재 제안', image3: '/media/koreahospital/04-content-management.png', image3Alt: '플랫폼별 콘텐츠 관리', mediaMode: 'tabs', tabLabelsKo: ['매일 핫이슈', '소재 풀', '콘텐츠 관리'], imageCaption: '매일 핫이슈 화면은 플랫폼 트렌드와 출처를 한곳에 모아 신호에서 콘텐츠 방향을 정한다.', image2Caption: '소재 풀은 열기·상태·에셋 진입점을 보존하고, AI 제안과 사람의 확인을 같은 흐름에서 처리한다.', image3Caption: '콘텐츠 관리는 플랫폼과 발행 상태별로 초안·대기·발행 콘텐츠를 정리해 도구 간 이동을 줄인다.' },
    { id: 'architecture', label: 'System Architecture', title: '입구에서 단말까지 5개 레인', body: '워크플로우 다이어그램이 아니라 실제로 돌아가는 에이전트 시스템 — 5개 레인(Workflow / Project Context / Agent / Web / Modal)이 각자 역할을 분담하고, 각 레인은 구체적인 기능 모듈에 대응한다.', image: '/media/koreahospital/08-settings.png', imageAlt: '운영자와 모델 스킬을 관리하는 시스템 설정', imageCaption: '시스템 설정에서 운영자, 모델 / Skill, 에셋 권한과 플랫폼 규칙을 관리해 협업 경계를 감사 가능하게 만든다.', mediaMode: 'feature' },
    { id: 'dashboard', label: 'Operations Dashboard', title: '오늘 뭐 해야 하는지 한 화면에', body: '운영 워크벤치 홈: 위쪽에 Agent 팀장 입력창, 그 아래 4개 데이터 카드 + 5단계 워크플로우 + 칸반 콘텐츠 보드. 운영자 3명이 같은 페이지를 열면, 상태는 항상 일치한다.', cards: [{ num: 'Agent', title: '6개 역할 · 실제 키 모두 정상', body: '팀장 입력창이 자연어 명령을 받고, 6개 역할 에이전트가 능력에 따라 작업을 분담한다.' }, { num: 'KPI', title: '4개 데이터 카드', body: '처리 대기 3 / 审核 대기 0 / 계정 매트릭스 10 / 사용 가능 에셋 9 — 한 페이지에서 모든 핵심 상태 확인.' }, { num: 'Pipeline', title: '5단계 파이프라인', body: '신호 → 전략 → 생산 →排期 → 회고, 색상이 데이터 카드와 일치해 한눈에 현재 막힘 위치 파악.' }, { num: 'Kanban', title: '칸반 콘텐츠 보드', body: '제작 대기 / 발행 대기 / 회고 대기 세 칸 드래그, 각 콘텐츠 카드는 출처 소재·현재 단계·담당자·다음 단계 표시.' }], image: '/media/koreahospital/01-operations-dashboard.png', imageAlt: '운영 워크벤치 홈 전체 화면', image2: '/media/koreahospital/09-toni-assistant.png', image2Alt: 'Toni Agent 대화 패널', mediaMode: 'tabs', tabLabelsKo: ['워크벤치 전체', 'Toni 어시스턴트'], imageCaption: '홈은 입력창·상태 카드·파이프라인·칸반을 한 장에 배치해 오늘의 운영 지도를 만든다.', image2Caption: 'Toni 어시스턴트는 “파이프라인 확인·발행 표시·새로고침” 같은 자연어 요청을 다음 액션으로 연결한다.' },
    { id: 'execution-plan', label: 'Multi-Agent Collaboration', title: '한 마디가 9단계 협업 대본이 된다', body: '운영자가 입력창에 "샤오홍슈 최근 한국 의료 미용 핫이슈 검색해"라고 하면, 팀장은 연구원·전략가·리스크审核에게 분배하고, 각 역할은 독립적으로 작업한다. 결과는 롤백 가능, 재사용 가능.', cards: [{ num: 'Researcher', title: '연구원', body: 'space-xhs-hotspot 스킬 호출, 키워드로 최근 30일 고인터랙션 노트를 가져와 핫이슈 표·트렌드 판단·출처 URL 모두 기록.' }, { num: 'Strategist', title: '전략가', body: '연구원 결과를 바탕으로 가장 잠재력 있는 트렌드 방향을 선별, 논의 열기·성장 곡선·실행 가능성 표시, 우선순위 제안.' }, { num: 'Compliance', title: '리스크审核', body: '전략가 출력에 컴플라이언스 스캔 — 의료 미용 광고법·플랫폼 규칙·의료진 授权, 레드라인 적중 시 즉시 반려 + 수정 제안.' }], image: '/media/koreahospital/06-execution-plan.png', imageAlt: '멀티 에이전트 실행 계획과 연구 결과', image2: '/media/koreahospital/05-asset-detail.png', image2Alt: '에셋 센터의 권한·분류 상세', mediaMode: 'tabs', tabLabelsKo: ['실행 계획', '에셋 상세'], imageCaption: '실행 계획은 연구원·전략가·요약 역할의 산출물과 출처·데이터·롤백 가능한 협업 증거를 남긴다.', image2Caption: '에셋 상세는 권한·분류·사용 횟수·다운로드 권한을 기록해 의료 미용 소재를 발행 전에 검증한다.' },
    { id: 'post-analysis', label: 'Data Center', title: '데이터는 거짓말하지 않는다: "미제공"을 정직하게 표시', body: '인터랙션율·공유율·팔로워 전환율은 모두 유효 조회수를 분모로 한다. 샘플 1000 미만은 귀인 결론에 들어가지 않고; 공식 파일에 단일 글 팔로워 증가가 없으면 "미제공" 표시, 계정 일일 증가 팬으로 역산하지 않음.', cards: [{ num: '저샘플', title: '저샘플은 표시하되 귀인 안 함', body: '유효 조회수 1000 미만도 표시하되 중앙값과 귀인 결론에는 들어가지 않음.' }, { num: '플랫폼 분리', title: '플랫폼 분리 집계', body: '샤오홍슈 조회와 틱톡 재생 모두 유효 조회수, 두 플랫폼의 비율을 합치지 않음.' }, { num: '귀인 제조 안 함', title: '귀인 제조 안 함', body: '공식 파일에 단일 글 팔로워 증가가 없으면 "미제공" 표시, 계정 일일 증가 팬으로 역산하지 않음.' }], image: '/media/koreahospital/07-post-analysis.png', imageAlt: '게시물 분석과 데이터 센터', imageCaption: '데이터 센터는 플랫폼·계정·기간을 분리하고, 샘플 부족을 “미제공”으로 표시해 허위 귀인을 만들지 않는다.', mediaMode: 'feature' },
    { id: 'summary', label: 'Project Summary', title: '6 역할 · 7 단계 · 10 계정 · 1 워크벤치', body: 'Koreahospital 운영 워크벤치는 10개 도구를 이어 붙인 게 아니라, 10개 워크플로우를 하나의 워크벤치로 압축했다. 모든 동작이 추적 가능하고, 모든 숫자에 출처가 있으며, 모든 판단에 근거가 있다.', highlight: '사람이 최종 판단을 하고, AI는 보조 작업을 한다.', highlightLabel: '핵심 철학' },
  ],
};
