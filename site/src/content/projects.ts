...
const koreahospitalZh: ProjectDetail = {
  ...
  sections: [
    ...
    { id: 'execution-plan', label: 'Multi-Agent Collaboration', title: '六个 Agent，协同完成一条内容', body: '运营只需要说清目标，内置的六个 Agent 就会按职责接力：研究员找信号，策略师定方向，总编写内容，设计师做视觉，发布助手整理发布包，数据分析师把表现带回下一轮。每个角色独立工作，结果可追溯、可复用。', cards: [{ num: '01', title: '研究员 · researcher', body: '调用热点研究技能，按关键词拉取平台信号、竞品资料和用户问题，输出带来源的研究包。' }, { num: '02', title: '策略师 · strategist', body: '基于研究包与历史复盘确定账号定位、内容支柱、选题优先级和母版简报。' }, { num: '03', title: '总编 · writer', body: '结合母版简报、平台规则和账号语气，生成小红书文案或抖音脚本、标题与 CTA。' }, { num: '04', title: '设计师 · designer', body: '根据内容版本、素材授权和平台规格，产出封面方案、配图计划、分镜与素材清单。' }, { num: '05', title: '发布助手 · publisher', body: '把文案、图片、视频、标签和发布时间整理成平台发布包，交给运营人员确认后发布。' }, { num: '06', title: '数据分析师 · analyst', body: '汇总互动率、分享率、涨粉转化率等表现，形成复盘摘要并反馈给研究与策略。' }], image: '/media/koreahospital/06-execution-plan.png', imageAlt: '多 Agent 执行计划与研究结果', image2: '/media/koreahospital/05-asset-detail.png', image2Alt: '素材中心的授权与分类详情', mediaMode: 'tabs', tabLabelsZh: ['执行计划', '素材详情'], imageCaption: '执行计划展开六个 Agent 的协作证据，保留来源、数据和可回滚的结果。', image2Caption: '素材详情记录授权、分类、使用次数与下载权限，让素材在发布前可验证。' },
