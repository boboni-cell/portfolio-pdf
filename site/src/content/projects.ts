...
const koreahospitalZh: ProjectDetail = {
  ...
  subtitle: '面向品牌与团队的社媒运营工作台——可新建项目，统一管理账号、选题、内容、审核、发布与复盘。人主导判断，AI 承担执行。',
  ...
  sections: [
    { id: 'overview', label: 'Overview', title: 'AI 与人共驾的运营驾驶舱', body: '这是一个适合品牌、机构与个人团队使用的社媒运营工作台。用户可以随时新建项目，把账号定位、选题、内容生产、审核、发布、数据回填和复盘收进同一个界面：AI 负责研究和初稿，人负责最终判断。每一条内容的来源、版本、状态与发布后表现都可追溯，团队复盘建立在真实数据之上。', items: [{ label: 'AI 主导执行', body: '研究员、策略师、写手、风险审核、复盘员等角色各自独立工作，运营人员通过输入框与队长对话驱动整个流程。' }, { label: '人主导判断', body: 'AI 初审跑完风险、证据、格式扫描之后，仍由人做最终审核。涉及品牌、医疗、金融等敏感场景时，自动化不能取代人。' }, { label: '数据全程留痕', body: '每个选题、每篇内容、每次发布、每个数据快照都保存到项目数据库，事后复盘可逐条回看。' }] },
    { id: 'background', label: 'Why This Project', title: '为什么做这个工作台？', body: '社媒运营往往同时面对多账号、多平台、多角色协作：专业度、内容效率和复盘能力很难兼顾。一个 AI 工具解决不了结构问题，但一套可复用的工作流可以。', cards: [{ num: '01', title: '项目与账号越来越多', body: '品牌、机构或个人团队都可能同时运营多个项目和账号，每个账号定位、平台和人设不同。' }, { num: '02', title: '审核边界需要被看见', body: '效果对比、承诺性表述、未授权素材等风险分散在内容流程里，人工审核容易遗漏，全自动审核又可能误杀。' }, { num: '03', title: '数据没有回到下一轮', body: '内容发布之后，如果没有统一的数据快照，团队很难知道哪条内容为什么有效，复盘只能停留在感觉。' }, { num: '04', title: '单点 AI 工具制造搬运', body: '写文案、生图、剪视频各自独立，登录、格式和文件搬运反而增加负担。需要的是工作台，而不是工具合集。' }] },
...
const koreahospitalKo: ProjectDetail = {
  ...
  subtitle: '브랜드와 팀을 위한 소셜 미디어 운영 워크벤치 — 새 프로젝트를 만들고 계정·소재·콘텐츠·검수·발행·회고를 한곳에서 관리합니다. 사람의 판단, AI의 실행.',
  ...
  nextProject: { slug: 'milk-ribbon', name: 'Milk & Ribbon 브랜드 디자인' },
  sections: [
    { id: 'overview', label: 'Overview', title: 'AI와 사람이 함께하는 운영 조종석', body: '브랜드·기관·개인 팀이 사용할 수 있는 소셜 미디어 운영 워크벤치입니다. 프로젝트를 새로 만들고 계정 포지셔닝, 소재, 콘텐츠 제작, 검수, 발행, 데이터 회귀와 회고를 한 화면에 통합합니다. AI는 연구와 초안을 담당하고, 사람은 최종 판단을 합니다. 모든 콘텐츠의 출처·버전·상태·발행 후 성과를 추적할 수 있어 팀의 회고가 실제 데이터에 기반합니다.', items: [{ label: 'AI가 실행 주도', body: '연구원·전략가·작가·리스크 검수·회고 담당 등 역할이 각자 독립적으로 작업하며, 운영자는 입력창으로 팀장과 대화하며 전체 흐름을 이끈다.' }, { label: '사람이 판단 주도', body: 'AI 1차 심사가 리스크·증거·포맷을 스캔한 뒤에도 최종 판단은 사람 몫이다. 브랜드·의료·금융 등 민감한 장면에서 자동화는 사람을 대체할 수 없다.' }, { label: '데이터 전 과정 기록', body: '모든 소재·콘텐츠·발행·데이터 스냅샷이 프로젝트 데이터베이스에 저장되어 사후 회고 시 한 줄씩 다시 볼 수 있다.' }] },
    { id: 'background', label: 'Why This Project', title: '왜 이 워크벤치를 만들었는가?', body: '소셜 미디어 운영은 여러 프로젝트·플랫폼·역할을 동시에 다뤄야 해 전문성, 제작 속도와 회고를 함께 유지하기 어렵습니다. 단일 AI 도구는 구조 문제를 해결하지 못하지만, 재사용 가능한 워크플로우는 해결할 수 있습니다.', cards: [{ num: '01', title: '프로젝트와 계정의 증가', body: '브랜드·기관·개인 팀 모두 여러 프로젝트와 계정을 운영할 수 있고, 계정마다 포지셔닝·플랫폼·페르소나가 다르다.' }, { num: '02', title: '검수 경계를 보여줘야 함', body: '효과 비교, 약속성 표현, 무授权 소재 같은 위험이 콘텐츠 흐름에 흩어져 수동 검수는 놓치고 완전 자동화는 오살한다.' }, { num: '03', title: '데이터가 다음 라운드로 돌아오지 않음', body: '발행 후 데이터 스냅샷이 없으면 어떤 콘텐츠가 왜 효과적이었는지 알 수 없어 회고가 감에 머문다.' }, { num: '04', title: '단일 AI 도구의 수동搬运', body: '카피라이팅·이미지·영상 도구가 각각 로그인·포맷·파일 이동을 요구한다. 도구 모음이 아닌 워크벤치가 필요하다.' }] },
